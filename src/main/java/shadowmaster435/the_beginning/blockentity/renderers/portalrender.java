...
public class portalrender extends BlockEntityRenderer<portalentity> {
    ...
    private void method_23084(portalentity entity, float tickDelta, float g, Matrix4f matrix4f, VertexConsumer vertexConsumer) {
        float h = 1.0F;
        float i = 1.0F;
        float j = 1.0F;
        ...
        this.method_23086(entity, matrix4f, vertexConsumer, (float) (-1.0F + offset), 2.0F, (float) (1.0F + offset), 1.0F, (float) (2.0F + offset * -1), 2.0F, (float) (-1.0F + offset * -1), -1.0F, h, i, j, Direction.UP);
    }
